...
|------|--------:|-------------|---------|
| `seeds.jsonl` | 11,533 | Raw legal consultation seeds sourced from the `legal_question_answering` subset of DISC-Law-SFT. | Data-build pipeline |
...
| `law66_annot.jsonl` | 500 | 500 Real-World Legal Advice.Each is a real question posted on Chinese legal platforms (华律网, 律图, 法律快车, etc.). | `eval_ablation_clarify.py` |
